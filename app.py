...
def results():  # build a request object
    ...
    if action=='appointment':                                                                                  ###### Basic info ######
      ...
      for i in val:
        if (i=='high_Bp') or (i=='tightness around chest') :
            cardio[i] = 1
            symptoms.append(i)
    ...
    elif action=='fix.appointment':             ## Fix appointment
       global date
  ...
  "followupEventInput": {
    ...
    "languageCode": "en"
      ...
      #return { "fulfillmentText": "Sorry, That date is not available"}   #####Handle this
       print(date)
       print(specialty)
